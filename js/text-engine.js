...
// string, array -> exit
export let getExit = (dir, exits) => exits.find(exit =>
...
// string -> room
export let getRoom = (id) => disk.rooms.find(room => room.id === id);
...
// get item by name
// string -> item
export let getItem = (name) => getItemInInventory(name) || getItemInRoom(name, disk.roomId)
...
// disk -> nothing
export let loadDisk = (uninitializedDisk) => {
